...
static MAKE_TOGGLE_CONVAR(mom_hud_conc_entpanels_enable, "1", FLAG_HUD_CVAR,
                          "Toggles whether concs have their fuse timer displayed above them as an ent panel.\n");
static MAKE_TOGGLE_CONVAR(mom_hud_conc_entpanels_fade_enable, "1", FLAG_HUD_CVAR,
                          "Toggles whether the conc ent panels fade after a certain distance.\n");
static MAKE_TOGGLE_CONVAR(mom_hud_conc_entpanels_label_enable, "0", FLAG_HUD_CVAR,
                          "Toggles whether conc ent panels display a label with the remaining fuse timer in seconds.\n");
static MAKE_CONVAR(mom_hud_conc_entpanels_fade_dist, "100", FLAG_HUD_CVAR,
                   "The amount of units to linearly fade the conc ent panel over.\n", 1, MAX_TRACE_LENGTH);
static MAKE_CONVAR(mom_hud_conc_entpanels_fade_start, "4096", FLAG_HUD_CVAR,
